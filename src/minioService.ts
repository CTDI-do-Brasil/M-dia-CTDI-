...
const endpoint = (import.meta as any).env.VITE_MINIO_ENDPOINT || "https://minio-api.ctdibrasil.com.br";
const bucketName = (import.meta as any).env.VITE_MINIO_BUCKET || "midia-ctdi";
const accessKeyId = (import.meta as any).env.VITE_MINIO_ACCESS_KEY || "admin";
const secretAccessKey = (import.meta as any).env.VITE_MINIO_SECRET_KEY || "9e6014c2d78f6c84";
